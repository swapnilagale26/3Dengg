...
class company_edit_form extends \company_moodleform {
    ...
    public function definition() {
        ...
        //Manju: Changing textbox to dropdown. 11/01/2022.
        $cities = array('Adilabad',
	'Anantapur',
	'Chittoor',
	'Kakinada',
	'Guntur',
	...
	'Uttar Dinajpur'
        ...
        asort($cities);
        $cities['0'] = 'Select Town/City';
        $mform->addElement('select', 'city', get_string('companycity', 'block_iomad_company_admin'), $cities);
