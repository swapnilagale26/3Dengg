...
$string['dashboardtext'] = 'Click here to start using';
$string['iomad_welcome:addinstance'] = 'Add a new Welcome block';
$string['iomad_welcome:myaddinstance'] = 'Add a new Welcome block to the users dashboard';
...
$string['privacy:metadata'] = 'The Welcome block only shows data stored in other locations.';
