...
$string['addedtogroup'] = 'Added to batch "{$a}"';
$string['addedtogroupnot'] = 'Not added to batch "{$a}"';
$string['addedtogroupnotenrolled'] = 'Not added to batch "{$a}", because not enrolled in course';
...
$string['coursehelpforce'] = 'Force the course batch mode to every activity in the course.';
...
$string['creatinggroupings'] = 'Creating batching';
$string['creatinggroupingsgroups'] = 'Adding batches into batching';
$string['creatinggroups'] = 'Creating batches';
...
$string['databaseupgradegroups'] = 'Batches version is now {$a}';
...
$string['editgroupprofile'] = 'Edit batch profile';
...
$string['idnumbergroup'] = 'Batch ID number';
$string['idnumbergroup_help'] = 'The ID number of a batch is only used when matching the batch against external systems and is not displayed anywhere on the site. If the batch has an official code name it may be entered, otherwise the field can be left blank.';
$string['idnumbergrouping'] = 'Batching ID number';
$string['idnumbergrouping_help'] = 'The ID number of a batching is only used when matching the batching against external systems and is not displayed anywhere on the site. If the batching has an official code name it may be entered, otherwise the field can be left blank.';
...
$string['nostudentsingroup'] = 'There are no students in this batch yet';
...
$string['notingroup'] = 'Sorry, but you need to be part of a batch to see this page.';
...
$string['selectagroup'] = 'Select a batch';
...
$string['shortnamecourse'] = 'Course Code';
...
$string['writinggroupingsgroupsinfo'] = 'Writing batchings-batches info';
$string['writinggroupingsinfo'] = 'Writing batchings info';
$string['writinggroupsinfo'] = 'Writing batches info';
