...
class local_attendance_trainer extends moodleform{
    ...
    public function definition(){
        ...
        $mform->settype('trainer', PARAM_RAW);
        $mform->addRule('trainer', get_string('required'), 'required', null, 'client');
    ...
    function validation($data, $files) {
        ...
        if(empty($data['trainer'])){
                $errors['trainer'] = "Please Select the trainer";
        }
        return $errors;
    }
}