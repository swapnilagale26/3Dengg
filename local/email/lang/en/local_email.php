...
$string['course_classroom_manager_denied_name'] = 'Lab mananager training event access denied';
...
$string['course_classroom_manager_denied_name_help'] = 'Template sent out to Lab manager when a user has been denied access to a training event.';
