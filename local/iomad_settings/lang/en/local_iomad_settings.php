...
$string['iomad_sync_department'] = 'Sync company lab with profile';
$string['iomad_sync_department_help'] = 'Selecting this will keep the user profile field for lab in sync with the name of the company department that the user is in.';
