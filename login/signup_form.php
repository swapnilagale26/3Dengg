...
class login_signup_form extends moodleform implements renderable, templatable {
    function definition() {
        ...
        $mform->addElement('text', 'phone1', get_string('phone'), 'maxlength="100" size="25"');
        $mform->setType('phone1', PARAM_RAW_TRIMMED);
        $mform->addRule('phone1', get_string('missingphone'), 'required', null, 'server');
        
        //2. Date of birth./skype
        $datearray = array('startyear' => 1980, 'stopyear'  => 2030,'timezone'  => 99,'optional'  => false);
        $mform->addElement('date_selector', 'skype', 'Birth Date', $datearray);
        $mform->setType('skype', PARAM_RAW);
        $mform->addRule('skype', 'Missing Date of Birth', 'required', null, 'server');
        
        //3. Adhar Number/yahoo
        $mform->addElement('text', 'yahoo', 'Adhar Number', 'maxlength="100" size="25"');
        $mform->setType('yahoo', PARAM_RAW_TRIMMED);
        
        //4. College Enrollment Number/aim
        $mform->addElement('text', 'aim', 'College Enrollment Number', 'maxlength="100" size="25"');
        $mform->setType('aim', PARAM_RAW_TRIMMED);
        ...
        //4. College Enrollment Number/aim
        $mform->addElement('text', 'icq', 'Semister', 'maxlength="100" size="25"');
        $mform->setType('icq', PARAM_RAW_TRIMMED);
