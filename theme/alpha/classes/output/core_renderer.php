...
class core_renderer extends \core_renderer {
    ...
    public function full_header() {
        ...
        return $this->render_from_template('theme_alpha/header', $header);
        // MODIFICATION START:
        ...
        if (get_config('theme_alpha', 'showhintcourseguestaccess') == 1
            ...
            $html .= get_string('showhintcourseguestaccessgeneral', 'theme_alpha',
    ...
    public function fp_header() {
        ...
        $header->pageheadingbutton = $this->page_heading_button();
        $header->courseheader = $this->course_header();
        return $this->render_from_template('theme_alpha/header-fp', $header);
    }
    ...
    public function user_menu($user = null, $withlinks = null) {
        ...
        if (isguestuser()) {
            $returnstr = '<div class="badge-guest" title="' . get_string('loggedinasguest') . '"><i class="icon fas fa-user-secret"></i></div>';
