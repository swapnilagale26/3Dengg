...
class provider implements
    ...
    const FP_DRAWER_OPEN_NAV = 'drawer-open-nav-fp';
    ...
    public static function get_metadata(collection $items) : collection {
        ...
        $items->add_user_preference(self::FP_DRAWER_OPEN_NAV, 'privacy:metadata:preference:fpdraweropennav');
        return $items;
    }
    ...
    public static function export_user_preferences(int $userid) {
        ...
        $fpdraweropennavpref = get_user_preferences(self::FP_DRAWER_OPEN_NAV, null, $userid);
        ...
        if (isset($fpdraweropennavpref)) {
            $preferencestring = get_string('privacy:fpdrawernavclosed', 'theme_alpha');
            if ($fpdraweropennavpref == 'true') {
                $preferencestring = get_string('privacy:fpdrawernavopen', 'theme_alpha');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_alpha',
                self::FP_DRAWER_OPEN_NAV,
                $fpdraweropennavpref,
                $preferencestring
            );
        }
