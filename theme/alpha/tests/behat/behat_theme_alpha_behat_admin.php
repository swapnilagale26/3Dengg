 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_alpha_behat_admin extends behat_admin {
        ...
        foreach ($data as $label => $value) {
            ...
            try {
                $fieldxpath = "//*[self::input | self::textarea | self::select]" .
                    ...
                    "[@id=//label[contains(normalize-alpha(.), $label)]/@for or " .
                    "@id=//span[contains(normalize-alpha(.), $label)]/preceding-sibling::label[1]/@for]";
                ...
                $fieldxpath = "//*[label[contains(., $label)]|span[contains(., $label)]]" .
                    "/ancestor::div[contains(concat(' ', normalize-alpha(@class), ' '), ' form-item ')]" .
