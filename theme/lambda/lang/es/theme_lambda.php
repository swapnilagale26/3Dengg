...
$string['linkedindesc'] = 'Introduce la URL de tu p&aacute;gina de LinkedIn. (p.ej. http://www.linkedin.com/company/miescuela)';
$string['chat'] = 'URL de la aplicación de chat';
$string['chatdesc'] = 'Ingrese la URL de una aplicación de chat.';
$string['socials_phone'] = 'Número de teléfono';
$string['socials_phone_desc'] = 'Ingrese un número de teléfono para que se muestre como contacto.';
