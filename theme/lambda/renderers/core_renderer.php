 ...
 */
 ...
 class theme_lambda_core_renderer extends core_renderer {
    ...
    public function custom_menu($custommenuitems = '') {
        ...
        $check1 = $DB->get_field('role_assignments','id',array('userid'=>$USER->id,'roleid'=>15));
        
        if(is_siteadmin() || !empty($check) || !empty($check1)){
            if(empty($check1)){
            $branchlabel = "Lab Management";
            $branchurl   = new moodle_url('/cohort/index.php');
            $branchtitle = $branchlabel;
            $branchsort  = 10000;
            $branch = $custommenu->add($branchlabel, $branchurl, $branchtitle, $branchsort);

            $branchlabel = "Trainer Management";
            $branchurl   = new moodle_url('/local/trainer/index.php');
            $branchtitle = $branchlabel;
            $branchsort  = 10000;
            $branch = $custommenu->add($branchlabel, $branchurl, $branchtitle, $branchsort); 

            $branchlabel = "Batch Management";
            $branchurl   = new moodle_url('/local/batch/index.php');
            $branchtitle = $branchlabel;
            $branchsort  = 10000;
            $branch = $custommenu->add($branchlabel, $branchurl, $branchtitle, $branchsort);

            $addlabel = "Create Batch";
            $addurl   = new moodle_url('/local/batch/create_batch.php');
            $addtitle = $addlabel;
            $addsort  = 10000;
            $branch->add($addlabel, $addurl, $addtitle, $addsort);

            $addlabel = "Batch list";
            $addurl   = new moodle_url('/local/batch/index.php');
            $addtitle = $addlabel;
            $addsort  = 10000;
            $branch->add($addlabel, $addurl, $addtitle, $addsort);

            // $addlabel = "Participant Enrollment";
            // $addurl   = new moodle_url('/local/batch/add_student.php');
            // $addtitle = $addlabel;
            // $addsort  = 10000;
            // $branch->add($addlabel, $addurl, $addtitle, $addsort);

            $addlabel = "Participants Details";
            $addurl   = new moodle_url('/local/batch/student_list.php');
            $addtitle = $addlabel;
            $addsort  = 10000;
            $branch->add($addlabel, $addurl, $addtitle, $addsort);
}
            ...
            $addlabel = "Consolidated report";
            $addurl   = new moodle_url('/local/allreports/consolidated_report.php');
            $addtitle = $addlabel;
            $addsort  = 10000;
            $branch->add($addlabel, $addurl, $addtitle, $addsort);

            $addlabel = "Trainer Attendance";
            $addurl   = new moodle_url('/local/allreports/trainer_attendance.php');
            $addtitle = $addlabel;
            $addsort  = 10000;
            $branch->add($addlabel, $addurl, $addtitle, $addsort);

            $addlabel = "Trainer Utilization";
            $addurl   = new moodle_url('/local/allreports/trainer_utilization.php');
            $addtitle = $addlabel;
            $addsort  = 10000;
            $branch->add($addlabel, $addurl, $addtitle, $addsort);

            $addlabel = "Participant Performance";
            $addurl   = new moodle_url('/local/allreports/participant_performance.php');
            $addtitle = $addlabel;
            $addsort  = 10000;
            $branch->add($addlabel, $addurl, $addtitle, $addsort);

            $addlabel = "Batch Progress";
            $addurl   = new moodle_url('/local/allreports/batch_progress.php');
            $addtitle = $addlabel;
            $addsort  = 10000;
            $branch->add($addlabel, $addurl, $addtitle, $addsort);

            $addlabel = "Availibility Report";
            $addurl   = new moodle_url('/local/allreports/availability.php');
            $addtitle = $addlabel;
            $addsort  = 10000;
            $branch->add($addlabel, $addurl, $addtitle, $addsort);

            $addlabel = "Lab Engagement";
            $addurl   = new moodle_url('/local/allreports/lab_report.php');
            $addtitle = $addlabel;
            $addsort  = 10000;
            $branch->add($addlabel, $addurl, $addtitle, $addsort);
            ...
            $addlabel = "Lab Utilization";
            $addurl   = new moodle_url('/local/allreports/lab_utilization.php');
            $addtitle = $addlabel;
            $addsort  = 10000;
            $branch->add($addlabel, $addurl, $addtitle, $addsort);

            $addlabel = "Participant Attendance";
            $addurl   = new moodle_url('/local/allreports/attendance.php');
            $addtitle = $addlabel;
            $addsort  = 10000;
            $branch->add($addlabel, $addurl, $addtitle, $addsort);
